...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-cubes"></i> Sub-criteria</h1>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold"><i class="fa fa-table"></i>  Data Sub-criteria</h6>
    </div>

    <div class="card-body">
		<div class="alert alert-info">
			The method of assessment on the criteria is of all direct input types.
		</div>
	</div>
</div>
<?php
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold"><i class="fa fa-table"></i> <?= $data['nama']." (".$data['kode_kriteria'].")" ?></h6>
			
			<a href="#tambah<?= $data['id_kriteria']; ?>" data-toggle="modal" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Add Data </a>
		</div>
    </div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> ADD <?= $data['nama'] ?></h5>
				...
				<form action="" method="post">
					<div class="modal-body">
						...
						<div class="form-group">
							<label class="font-weight-bold">Name Sub-criteria</label>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-times"></i> Delete</button>
						<button type="submit" name="tambah" class="btn btn-success"><i class="fa fa-save"></i> Save</button>
					</div>
				</form>
			</div>
		</div>
							...
							<div class="modal-content">
								...
								<form action="list-sub-kriteria.php?id=<?php echo $d['id_sub_kriteria']; ?>" method="post">
									...
									<div class="modal-body">
										...
										<div class="form-group">
											<label class="font-weight-bold">Typle</label>

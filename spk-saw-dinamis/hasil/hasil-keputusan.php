                            ...
                            <div class="card-block border-bottom">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Decision Results Data</li>
                                    </ol>
                                </nav>
                                <h3>Vendor/Supplier Performance Results Data</h3>
                                <div class="row">
                                    <div class="col-3">
                                        <form method="get">
                                                            ...
                                                            <?php foreach ($arr as $key => $val) : ?>
                                                                <?php foreach ($val as $k => $v) : ?>
                                                                    <tr>
                                                                        ...
                                                                        <?php if ($k == 0) : ?>
                                                                            <td rowspan="<?php echo count($val) ?>" class="text-center">
                                                                                <a class="btn-sm btn-primary" href="../hasil/cetak-hasil.php?kode=<?= $v->kode_rank ?>" target="_blank"><i class="fas fa-print"></i> Print</a>
                                                                                <a class="btn-sm btn-danger" href="../hasil/hapus-hasil.php?kode=<?= $v->kode_rank ?>" onclick="return confirm('Yakin akan menghapus data ini?')"><i class="feather icon-trash-2"></i> Wipe</a>
                                                                            </td>
                                                                        <?php endif ?>
                                                                    </tr>
                                                                <?php endforeach; ?>

                            ...
                            <div class="card-block border-bottom">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">SAW Calculation</li>
                                    </ol>
                                </nav>
                                <hr>
                                <div class=" page-wrapper">
                                    <h3>1. Data of each product against criteria</h3>
                                ...
                                <div class="page-wrapper">
                                    <h3 class="mt-5">2. Calculating Normalized Values</h3>
                                ...
                                <div class="page-wrapper">
                                    <h3 class="mt-5">3. Normalization Results</h3>
                                ...
                                <div class="page-wrapper">
                                    <h3 class="mt-5">4. Calculating Preference Values</h3>
                                    <table id="" class="table table-striped text-center">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php endforeach; ?>
                                            <tr>
                                                <th colspan="2">Criterion Weights</th>
                                                <?php foreach ($kriteria as $col) : ?>
                                ...
                                <div class="page-wrapper">
                                    <h3 class="mt-5">5. Preference Results</h3>
                                    <table id="" class="table table-striped text-center">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                ...
                                <div class="page-wrapper">
                                    <h3 class="mt-5">6. Calculate the total preference value</h3>
                                    <table id="" class="table table-striped text-center">
                                        <thead>
                                            <tr>
                                                <th>ID</th>

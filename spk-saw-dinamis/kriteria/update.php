                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="kriteria">Types of Criteria</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="bobotKriteria">Criterion Weights (%)</label>
                                            ...
                                            <a href="../kriteria/index.php" type="submit" class="btn btn-success btn-sm">Return</a>
                                        </form>
                                    </div>
                                </div>
                            </div>

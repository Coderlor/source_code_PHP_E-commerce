...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-cube"></i> Sub-criteria</h1>
			...
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<select name="ada_pilihan" class="form-control" required>
						<option value="">--Choose--</option>
						<option value="0" <?php if($d['ada_pilihan']=="0") {echo "selected";} ?>>Direct Input</option>
						<option value="1" <?php if($d['ada_pilihan']=="1") {echo "selected";} ?>>Sub Criteria Options</option>						
					</select>
				</div>
			</div>
		</div>

<?php include("includes/header.inc.php"); ?>
    <div id="container" class="container">
			...
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#rangking" aria-controls="rangking" role="tab" data-toggle="tab">Ranking Report</a></li>
					<li role="presentation" style="cursor: pointer;"><a id="cetak" role="tab">Print Report 1 (PrintMe)</a></li>
					<li role="presentation"><a href="laporan-cetak.php" role="tab">Print Report 2 (FPDF)</a></li>
					<li role="presentation" style="cursor: pointer;"><a onClick ="$('#container').tableExport({type:'png',escape:'false'});" role="tab">Print Report 3 (tableExport)</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<h4>Criteria Alternative Value</h4>
					<table width="100%" class="table table-striped table-bordered">
						<thead>
							<tr>
								<th rowspan="2" style="vertical-align: middle" class="text-center">Alternative</th>
					...
					<h4>Weighted Product Ranking Method</h4>
						<table width="100%" class="table table-striped table-bordered">
							<thead>
								<tr>
									<th rowspan="2" style="vertical-align: middle" class="text-center">Alternative</th>
									<th colspan="<?php echo $stmt2->rowCount(); ?>" class="text-center">Criteria</th>
									<th rowspan="2" style="vertical-align: middle" class="text-center">Vector S</th>
									<th rowspan="2" style="vertical-align: middle" class="text-center">Vector V</th>
								</tr>
								<tr>
	...
	<footer class="text-center">&copy; 2023</footer>
	</div>

...
<div class="row">
	  <div class="col-xs-12 col-sm-12 col-md-12">
			  <ol class="breadcrumb">
					  ...
					  <li><a href="nilai-awal.php">Initial Value</a></li>
	  	...
	  	<div class="panel panel-default">
                ...
                <div class="form-group">
                    <label for="id_alternatif">Officer</label>
                    ...
                    <select class="form-control" name="periode">
                        ...
                        <?php endfor; ?>
								...
								<div class="btn-group">
										...
										<button type="button" onclick="location.href='nilai-awal.php'" class="btn btn-default">Return</button>
								</div>
						</form>
					</div>
			</div>

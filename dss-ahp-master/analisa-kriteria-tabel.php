...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		<ol class="breadcrumb">
		  ...
		  <li><a href="analisa-kriteria.php">Criteria Analysis</a></li>
		  <li class="active">Criteria Analysis Table</li>
		</ol>
		<div class="row">
			<div class="col-md-6 text-left">
				<strong style="font-size:18pt;"><span class="fa fa-table"></span> Comparison of Criteria</strong>
			</div>
			<div class="col-md-6 text-right">
				<form method="post">
          <button name="hapus" class="btn btn-danger">Erase All Data</button>
				</form>
			</div>
		</div>
		<br/>

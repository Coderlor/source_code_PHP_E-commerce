...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <p style="margin-bottom:10px;">
      <strong style="font-size:18pt;"><span class="fa fa-pencil"></span> Change Alternative</strong>
    </p>
      <div class="panel panel-default">
        <div class="panel-body">
          <form method="POST">
            <div class="form-group">
                <label for="id">ID Alternative</label>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="kelamin" id="kelamin" required="on">
                    <option value="">---</option>
                    <option value="pria"<?=($altObj->kelamin == "pria")? "selected=\"on\"" : "" ?>>Man</option>
                    <option value="wanita"<?=($altObj->kelamin == "wanita")? "selected=\"on\"" : "" ?>>Women</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="btn-group">
              ...
              <button type="button" onclick="location.href = 'data-alternatif.php'" class="btn btn-default">Return</button>
            </div>
          </form>
        </div>
      </div>

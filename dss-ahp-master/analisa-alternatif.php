...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li class="active">Alternative Analysis</li>
			<li><a href="#" data-toggle="modal" data-target="#myModalalt">Alternative Analysis Table</a></li>
		</ol>
			...
			<div class="panel-body">
				<form method="post" action="analisa-alternatif-tabel.php">
					<div class="row">
						<div class="col-xs-12 col-md-3">
							<div class="form-group">
								<p style="padding:10px 0;"><label>Select Criteria</label></p>
							</div>
						</div>
					...
					<?php $no=1; foreach ($r as $k => $v): ?>
						...
						<?php endfor; ?>
					<?php endforeach; ?>
					<button type="submit" name="submit" class="btn btn-dark">Furthermore<span class="fa fa-arrow-right"></span></button>
				</form>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabelalt">Select Criteria</h4>
			</div>
...
<div class="modal fade" id="modalNilaiDetail" tabindex="-1" role="dialog" aria-labelledby="modalNilaiDetailLabel">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="modalNilaiDetailLabel">Detail Value</h4>
			</div>
			<div class="modal-body">

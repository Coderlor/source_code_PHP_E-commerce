    ...
    <form method="post">
      <div class="row">
        ...
        <div class="col-md-6 text-right">
          <div class="btn-group">
            <button type="submit" name="hapus-contengan" class="btn btn-danger">Remove Scratches</button>
            <button type="button" onclick="location.href='user-baru.php'" class="btn btn-primary">Add Data</button>
          </div>
        </div>
      </div>
      <br/>

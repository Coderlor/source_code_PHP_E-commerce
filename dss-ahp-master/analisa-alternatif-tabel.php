	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<ol class="breadcrumb">
			  ...
			  <li><a href="analisa-alternatif.php">Alternative Analysis</a></li>
			  <li class="active">Alternative Analysis Table</li>
			</ol>
			<div class="row">
				<div class="col-md-6 text-left">
					<strong style="font-size:18pt;"><span class="fa fa-table"></span> Alternative According to Criteria</strong>
				</div>

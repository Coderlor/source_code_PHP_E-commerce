...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		...
		<div class="row">
	      ...
	      <button type="button" onclick="location.href='index.php'" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Return</button>
			</div>
		</div>
		<br/>
	    ...
	    <thead>
	      <tr>
	        <th rowspan="3" class="text-center active">Alternative</th>
	        <th colspan="<?php $kri1a = $kriObj->readAll(); echo $kri1a->rowCount(); ?>" class="text-center">Criteria</th>
	      </tr>
				<tr>
	    ...
	    <thead>
	      <tr>
	        <th rowspan="2" class="text-center active">Alternative</th>
	        <th colspan="<?php $kri1b = $kriObj->readAll(); echo $kri1b->rowCount(); ?>" class="text-center">Criteria</th>
	        <th rowspan="2" class="text-center warning">The final result</th>
	      </tr>
	      <tr>

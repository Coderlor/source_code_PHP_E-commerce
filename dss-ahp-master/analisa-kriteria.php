...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li class="active">Criteria Analysis</li>
			<li><a href="analisa-kriteria-tabel.php">Criteria Analysis Table</a></li>
		</ol>
		<p style="margin-bottom:10px;">
			<strong style="font-size:18pt;"><span class="fa fa-bomb"></span> Criteria Analysis</strong>
		</p>

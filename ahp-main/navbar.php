...
<body>
  <nav>
    ...
    <ul class="menu">
      ...
      <li><a href="kriteria.php">Criterion</a><i class="bi bi-chevron-right panah"></i></li>
      <li><a href="alternatif.php">Alternative</a><i class="bi bi-chevron-right panah"></i></li>
      <li><a href="bobot_kriteria.php">Comparison of Criteria</a><i class="bi bi-chevron-right panah"></i></li>
      <li onclick="drpdn()"><span>Alternative Comparison</span><i class="bi bi-chevron-right panah"></i>

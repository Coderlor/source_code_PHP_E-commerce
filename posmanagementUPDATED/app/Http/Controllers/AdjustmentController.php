...
class AdjustmentController extends BaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        \Illuminate\Support\Facades\DB::transaction(function () use ($request, $id, $current_adjustment) {
    ...
    public function getNumberOrder()
    {
        ...
        $last = \Illuminate\Support\Facades\DB::table('adjustments')->latest('id')->first();
